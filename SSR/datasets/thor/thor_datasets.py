...
class THORDatasetCache(Dataset):
    ...
    def __init__(self, data_dir, train_ids, test_ids, img_h=None, img_w=None):
        ...
        poses = np.concatenate([poses, np.array([[[0.0, 0.0, 0.0, 1.0]]] * poses.shape[0])], axis=-2)
        ...
        self.semantic_classes = np.arange(54).astype(np.uint8)
